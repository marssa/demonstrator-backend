...
// * limitations under the License.
// */
//package org.marssa.demonstrator.test.control.path_planning;
//
...
////		 * "http://localhost:8182/pathPlanner/waypoints"); ClientResource
////		 * itemResource = null;
////		 * 
////		 * // Create a new item ArrayList<Waypoint> wayPointList = new
////		 * ArrayList<Waypoint>(); Waypoint item1 = new
////		 * Waypoint("01","Start Point",new Coordinate(new Latitude(new
////		 * DegreesDecimal(35.983267)) , new Longitude(new
////		 * DegreesDecimal(14.387419)))); Waypoint item2 = new
////		 * Waypoint("02","End Point",new Coordinate(new Latitude(new
////		 * DegreesDecimal(36.000184)) , new Longitude(new
////		 * DegreesDecimal(14.376021))));
////		 * 
////		 * Representation r = itemsResource.post(getRepresentation(item1)); if
////		 * (itemsResource.getStatus().isSuccess()) {
////		 * System.out.println("Success......"); ClientResource startFollowing =
////		 * new ClientResource(
