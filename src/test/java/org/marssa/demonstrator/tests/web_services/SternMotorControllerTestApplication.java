...
public class SternMotorControllerTestApplication extends Application {
	
		private ArrayList<CacheDirective> cacheDirectives;
		private SternDriveMotorControllerTest motorController;
		
		public SternMotorControllerTestApplication(ArrayList<CacheDirective> cacheDirectives) {
